          ...
          <div v-if="!finished">
            ...
            <div class="evaluate" v-else>
              <div class="thematics-container" v-if="!evaluate_status">
                <topic-training class="fadeInAfter" v-if="step_topic == 1" :is-maker="true"></topic-training>
                <topic-training class="fadeInAfter" v-if="step_topic == 2" :is-maker="true"></topic-training>
                <topic-training class="fadeInAfter" v-if="step_topic == 3" :is-maker="true"></topic-training>
                <topic-training class="fadeInAfter" v-if="step_topic == 4" :is-maker="true"></topic-training>
              </div>
