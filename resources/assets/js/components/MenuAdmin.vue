<template>
  <div class="navbar-items">
    ...
    <router-link to="/dashboard" class="item" :class="{'active' : $route.name == 'Dashboard'}">Dashboard</router-link>
    <router-link to="/groups" class="item" :class="{'active' : $route.name == 'Groups'}">Grupos</router-link>
